...
<head>
    ...
    <link href="${ctx}/h_style/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${ctx}/h_style/img/profile_small.jpg" /></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="${ctx}/admin/BaseUser/index_v1.html" data-index="0">用户管理</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0"      width="100%" height="100%" src="${ctx}/html/index_v1.html?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
...
<script src="${ctx}/h_style/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="${ctx}/h_style/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="${ctx}/h_style/js/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="${ctx}/h_style/js/hplus.js?v=4.1.0"></script>
<script type="text/javascript" src="${ctx}/h_style/js/contabs.js"></script>

<!-- 第三方插件 -->
<script src="${ctx}/h_style/js/plugins/pace/pace.min.js"></script>
